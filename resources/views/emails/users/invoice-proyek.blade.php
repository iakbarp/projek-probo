                                                    ...
                                                    <tr>
                                                        <td>
                                                            <small style="line-height: 2em">
                                                                <b style="font-size: 22px">Anda Mendapatkan Undangan Proyek dari {{$name}}</b><br>
                                                                Undangan proyek {{$judul}} dari {{$name}}
                                            ...
                                            <tr>
                                                <td>
                                                    <div class="alert alert-warning">
                                                        <span>Nama Proyek : {{$judul}}</span>
                                                        <br>
                                                        <span>Deskripsi : {{$deskripsi}}</span>
                                                        <br>
                                                        <span>Waktu : {{$waktu_pengerjaan}}</span>
                                                        <br>
                                                        <span>Biaya : {{$harga}}</span>
                                                        <br>
                                                        <span class="text-center">Mohon melakukan konfirmasi undangan proyek pada aplikasi {{env('APP_NAME')}}</span>
                                                    </div>
                                                </td>
                                            </tr>
                                        <tr>
                                                    ...
                                                    <tr>
                                                        <td align="center" width="600" class="full-width"
                                                            ...
                                                            <a class="zoom" id="activate" target="_blank"
                                                               href="{{route('dashboard.pekerja.proyek')}}">
                                                                DASHBOARD PROYEK</a>
                                                        </td>
                                                    </tr>
                                                </table>

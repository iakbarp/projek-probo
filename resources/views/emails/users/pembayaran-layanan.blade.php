                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        <b>{{$data->get_pengerjaan_layanan->get_service->judul}}</b>
                                                                    </td>
                                                                    <td>&emsp;</td>
                                                                    <td align="center"><b>1</b></td>
                                                                    <td>&emsp;</td>
                                                                    <td align="right">
                                                                        <b>Rp{{number_format($data->get_pengerjaan_layanan->get_service->harga,2,',','.')}}</b>
                                                                    </td>
                                                                </tr>
                                            ...
                                            <td>
                                                <div class="alert alert-info text-center">
                                                    <a target="_blank" style="color: #31708f;text-decoration: none"
                                                       href="{{route('dashboard.klien.layanan', [
                                                       'id' => $data->pengerjaan_layanan_id, 'invoice' => $invoice,
                                                       'url' => route('klien.update-pembayaran.pesanan',['id' => $data->pengerjaan_layanan_id]),
                                                       'data_url' => route('klien.data-pembayaran.pesanan',['id' => $data->id]),
                                                       'harga' => $data->get_pengerjaan_layanan->get_service->harga])}}">
                                                        ...
                                                        <td>
                                                            <small style="line-height: 2em">
                                                                <b style="font-size: 20px">
                                                                    Tetap awasi status pesanan layanan Anda pada halaman
                                                                    Dashboard Klien: Layanan</b><br>Untuk beralih ke
                                                                halaman tersebut, silahkan klik tombol Pesanan Layanan
                                                                berikut.
                                                            </small>
                                                        </td>
                                                    </tr>

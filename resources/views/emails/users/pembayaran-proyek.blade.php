                                        ...
                                        <tr>
                                            <td align="center" width="660">
                                                <a name="Logo" style="display:block" href="{{route('beranda')}}"
                                                   target="_blank">
                                                    <img src="https://i.ibb.co/TctM4hg/logotype.png" border="0"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <table>
                                                                <tr>
                                                                    <td>
                                                                        <b>{{$data->get_project->judul}}</b>
                                                                    </td>
                                                                    <td>&emsp;</td>
                                                                    <td align="center"><b>1</b></td>
                                                                    <td>&emsp;</td>
                                                                    <td align="right">
                                                                        <b>Rp{{number_format($data->get_project->harga,2,',','.')}}</b>
                                                                    </td>
                                                                </tr>
                                                                ...
                                                                <tr>
                                                                    ...
                                                                    <td colspan="4" align="right">
                                                                        ...
                                                                        $data->get_project->harga * 100,1)}}%</b>
                                                                    </td>
                                                                </tr>
                                                                @if($sisa > 0)
                                                                    <tr style="border-top: 1px solid #eee">
                                                                        ...
                                                                        <td colspan="4" align="right">
                                                                            <b>Rp{{number_format($data->get_project->harga - $sisa,2,',','.')}}</b>
                                                                        </td>
                                                                    </tr>
                                                                    <tr>
                                                ...
                                                <table border="0" cellpadding="10" cellspacing="0" width="100%"
                                                    ...
                                                    <tr>
                                                        <td>
                                                            ...
                                                            <hr class="hr-divider">
                                                            <span>{{\Carbon\Carbon::parse($data->created_at)
                                                            ->addDays(3)->format('l, j F Y')}}<br>
                                                            at {{\Carbon\Carbon::parse($data->created_at)
                                                            ->addDays(3)->format('H:i')}}
                                                            </span>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td>
                                                            <small><b>Faktur Pesanan</b></small>
                                                            <hr class="hr-divider">
                                                            <span>{{$invoice}}</span>
                                                        </td>
                                                    </tr>
                                            ...
                                            <td>
                                                <div class="alert alert-info text-center">
                                                    <a target="_blank" style="color: #31708f;text-decoration: none"
                                                       href="{{route('dashboard.klien.proyek', [
                                                       'id' => $data->proyek_id, 'invoice' => $invoice,
                                                       'url' => route('klien.update-pembayaran.proyek',['id' => $data->proyek_id]),
                                                       'data_url' => route('klien.data-pembayaran.proyek',['id' => $data->id]),
                                                       'harga' => $data->get_project->harga])}}">
                                        ...
                                        <tr>
                                            <td>
                                                <div class="alert alert-warning text-center">
                                                    ...
                                                    buktinya kepada pihak manapun kecuali <b>{{env('APP_NAME')}}</b>.
                                                </div>
                                            </td>
                                        </tr>
                                        <tr>
                                                        ...
                                                        <td>
                                                            <small style="line-height: 2em">
                                                                <b style="font-size: 20px">
                                                                    Tetap awasi status pesanan tugas/proyek Anda pada
                                                                    halaman Dashboard Klien: Tugas/Proyek</b><br>
                                                                Untuk beralih ke halaman tersebut, silahkan klik tombol
                                                                Pesanan Tugas/Proyek berikut.
                                                            </small>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                        ...
                                        <tr>
                                            ...
                                            <td align="center" valign="top" width="660" bgcolor="#1a1c21">
                                                <a name="Logo_1" style="display:block;" href="{{route('beranda')}}"
                                                   target="_blank">
                                                    <img src="https://i.ibb.co/Qp2GjKC/icon.png" alt="logo"
                                                            ...
                                                            <table border="0" align="center" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center" bgcolor="#1a1c21">
                                                                        <a href="https://play.google.com/store/apps/details?id=com.bagasku.mobile"><img
                                                                                class="zoom"
                                                                                src="http://i67.tinypic.com/2n8nadu.png"
                                                                                style="width: 15%"></a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                                        <a href="https://itunes.apple.com/id/app/bagasku.com/id1143444473?mt=8"><img
                                                                                class="zoom"
                                                    ...
                                                    <tr>
                                                        <td align="center">
                                                            <table border="0" align="center" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center"><a
                                                                            href="https://fb.com/ramadhanwahyu.gonzales"
                                                                    ...
                                                                    <td>
                                                                        <a href="https://twitter.com/ramadhanwahyuu5"
                                                                    ...
                                                                    <td>
                                                                        <a href="https://instagram.com/Ramadhan_Wahyu_11"
                                                                ...
                                                                <tr>
                                                                    <td align="center"
                                                                        ...
                                                                        <a name="Terms" class="footerlinks"
                                                                           ...
                                                                           href="{{route('ketentuan-layanan')}}"
                                                                           target="_blank">Ketentuan Layanan</a>&nbsp;&nbsp;&nbsp;&nbsp;
                                                            ...
                                                            <table border="0" cellspacing="0" cellpadding="0"
                                                                ...
                                                                <tr>
                                                                    <td align="center" class="footer-padding"
                                                                        ...
                                                                        Anda di situs {{env('APP_NAME')}} maka Anda
                                                                        dapat mengabaikan pesan ini atau menghubungi
                                                                        {{env('MAIL_USERNAME')}} untuk informasi lebih
                                                                        lanjut.<br><br>
                                                                        <span
                                                                            class="appleLinksWhite">+6281252658218</span>.
                                                                        <span class="appleLinksWhite">© {{now()->format('Y').' '.env('APP_NAME')}}. All rights reserved. Pohkecik, Dlanggu, Mojokerto, Jawa Timur — 61371.</span>
                                                                        <br>
                                                                        <div id="stat-div"

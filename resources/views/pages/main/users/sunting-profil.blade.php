...
@section('title', 'User '.env('APP_NAME').': Kelola Data Proyek | '.env('APP_TITLE'))
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <form id="delete-form-{{$item->id}}"
                                                  action="{{ route('akun.show.status_dokumen.delete',['id' => $item->id])}}"
                                                  method="POST"
                                                  style="display: none;">
        ...
        $("#add_dokumen").fireModal({
            ...
            onFormSubmit: function (modal, e, form) {
                ...
                let fake_ajax = setTimeout(function () {
                    ...
                    $.ajax({
                        type: "POST",
                        url: "{{route('akun.show.status_dokumen.store')}}",
                        data: form_data, //
                        processData: false,

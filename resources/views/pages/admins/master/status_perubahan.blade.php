...
@section('content')
    <section class="section">
        <div class="section-header">
            <h1>Kelola Data Perubahan Status</h1>
        </div>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <button class="btn btn-info btn-icon"
                                                    id="edit-perubahan-{{$item->id}}"
                                                    onclick="edit_perubahan('{{$item->id}}'
                                                        ,'{{$item->perubahan}}','{{$item->sebelum}}','{{$item->sesudah}}')">
                                                <i
...
@push('scripts')
    ...
    <script !src="">
        ...
        function update_perubahan() {
            $('#modal-edit-perubahan').ajaxSubmit({
                success: function (data) {
                    $("#updatePerubahanModal").modal('hide');
                    console.log(data);
        ...
        function edit_perubahan(id, perubahan, sebelum, sesudah) {
            $("#updatePerubahanModal").modal('show');
            $("#key_id_perubahan").val(id);
            $("#perubahan_edit").val(perubahan);

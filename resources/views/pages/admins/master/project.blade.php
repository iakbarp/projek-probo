                            ...
                            <table class="table table-striped" id="project-dt">
                                ...
                                @foreach($project as $item)
                                    <tr>
                                        ...
                                        <td>{{$item->waktu_pengerjaan}} Hari</td>
                                        <td>Rp. {{number_format($item->harga)}}</td>
                                        <td>@if($item->get_pengerjaan != null)
                                                @if($item->get_pengerjaan->selesai == 1)
                                                    <div class="badge badge-success">Project Selesai Dikerjakan</div>
                                                    @else
                                                    <div class="badge badge-info">Tahap Pengerjaan</div>
                                                @endif
                                            @else
                                        ...
                                        <th>
                                            <a href="{{route('detail.proyek',['username' => $item->get_user->username, 'judul' =>
